...
QT_MOC_LITERAL(1, 8, 14), // "encoderChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "value"
QT_MOC_LITERAL(4, 30, 13), // "buttonPressed"
QT_MOC_LITERAL(5, 44, 5) // "start"

    },
    "Encoder\0encoderChanged\0\0value\0"
    "buttonPressed\0start"
};
...
void Encoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->encoderChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Encoder::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Encoder::encoderChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Encoder::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Encoder::buttonPressed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Encoder::encoderChanged(int _t1)
{
